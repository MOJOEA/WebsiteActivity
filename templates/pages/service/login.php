...
<body>
    ...
    <div class="flex bg-gray-100 text-gray-800">
        ...
        <!--/////////////////////////////////////////////////////////////////////////////////////////////////////////-->
        <main class="flex-1 bg-gray-100 flex items-center justify-center mb-12">
            <div class="bg-white w-full max-w-md rounded-xl shadow-[0_0_20px_5px_rgba(0,0,0,0.1)] p-8 mt-12">
                <!-- =============================================================================================== -->
                <!-- =============================================================================================== -->
                <div class="text-center mb-6">
                    <!-- ------------------------------------------------------------------------------------------- -->
                    <div class="mx-auto w-14 h-14 bg-blue-100 rounded-full flex items-center justify-center"> ➜ </div>
                    <!-- ------------------------------------------------------------------------------------------- -->
